...
const KalymPlatform = () => {
  ...
  return (
    <section id="platform" className="py-32 px-6 bg-gradient-to-b from-black to-gray-900">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {features.map((feature, index) => (
            <Card key={index} className="bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700 hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
        ...
        {/* Registration Form */}
        <Card id="contact" className="bg-gradient-to-br from-gray-900 to-gray-800 border-emerald-500/20 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="border-b border-gray-700 pb-4">
                  <h3 className="text-xl font-semibold text-emerald-400">Contact Information</h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      className="bg-gray-800 border-gray-600 text-white focus:border-emerald-400"
                    />
                  </div>
                  <div className="space-y-2">
              ...
              <div className="space-y-6">
                <div className="border-b border-gray-700 pb-4">
                  <h3 className="text-xl font-semibold text-emerald-400">Organization Information</h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="position" className="text-gray-300">Position/Title *</Label>
                    <Input
                      id="position"
                ...
                <div className="space-y-2">
                  <Label htmlFor="industry" className="text-gray-300">Industry Sector *</Label>
                  <Select value={formData.industry} onValueChange={(value) => handleInputChange('industry', value)}>
                    <SelectTrigger className="bg-gray-800 border-gray-600 text-white focus:border-emerald-400">
              ...
              <div className="space-y-6">
                <div className="border-b border-gray-700 pb-4">
                  <h3 className="text-xl font-semibold text-emerald-400">AI Use Case Information</h3>
                </div>
                
                <div className="space-y-2">
                  <Label htmlFor="useCaseTitle" className="text-gray-300">AI Use Case Title *</Label>
                  <Input
                    id="useCaseTitle"
                ...
                <div className="space-y-2">
                  <Label htmlFor="useCaseDescription" className="text-gray-300">Detailed Description *</Label>
                  <Textarea
                    ...
                    className="bg-gray-800 border-gray-600 text-white focus:border-emerald-400 min-h-[120px]"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="currentStage" className="text-gray-300">Development Stage *</Label>
              ...
              <div className="text-center pt-8">
                <Button 
                  type="submit"
                  size="lg"
                  className="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white px-12 py-6 text-lg font-semibold rounded-full shadow-2xl transform hover:scale-105 transition-all duration-300"
                >
